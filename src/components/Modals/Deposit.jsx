...
const Deposite = () => {
    ...
    return (
        <div>
            <button className='bg-red-400 px-2 py-1.5 m-0.5 font-bold rounded' onClick={openModal}>
...
export const RechargeDeposit = () => {
    return (
        ...
        <div className='w-[30rem] h-[25rem] p-5 '>
