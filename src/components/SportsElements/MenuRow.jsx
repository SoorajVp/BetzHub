...
const MenuRow = () => {
    return (
        <div className='flex overflow-x-scroll gap-2 py-3'>
            ...
            <div className='flex'>
                <div className='shadow-lg gap-1 mt-2 border-2 border-primary transition duration-300 ease-in-out flex flex-col items-center bg-white rounded-md px-6 py-2'>
            ...
            {MenuList?.map((item, index) => (
                <div className='flex' key={index}>
                    <div className='shadow-lg gap-1 mt-2 border-2 border-gray-100 hover:border-primary transition duration-300 ease-in-out flex flex-col items-center bg-white rounded-md px-6 py-2'>
